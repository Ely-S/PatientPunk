...
class DemographicsExtractor(BaseExtractor):
    ...
    def __init__(
        ...
        *,
        ...
        # Default to {input_dir}/demographics.csv (matches the docstring). Without
        # this the subprocess falls back to a package-relative path, which writes
        # under site-packages in an installed wheel.
        self.output_path = Path(output_path) if output_path else self.input_dir / "demographics.csv"
