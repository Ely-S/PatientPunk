"""Prompt and response-contract definitions for KG claim extraction."""
...
def build_system_prompt() -> str:
    """Build the system prompt from the claim response contract."""
    blocks = []
    for ctype, (primary, extras) in CLAIM_TYPES.items():
        keys = ", ".join([f"{primary} (REQUIRED)"] + list(extras))
