...
def config_for(drug: str) -> str:
    """Return the canonical drug name for prompt generation.

    This is a pass-through for now. If per-drug prompt customization
    is needed later, this is where overrides would go.
    """
    return drug
