...
2. Allowed units are "mcg", "mg", and "g". Preserve the stated unit. When the author gives a
   bare number with no unit ("started on 1.5", ".25 to .5"), keep the number and set "unit"
   to null; never invent a unit. Do not extract mg/kg, percentages, or counts of pills,
   capsules, drops or sprays without a mass.
