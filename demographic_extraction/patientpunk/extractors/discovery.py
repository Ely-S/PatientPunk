...
Wraps ``old/discover_fields.py``.  Automatically discovers new biomedical
...
Requires an Anthropic API key in ``demographic_extraction/.env``.
...
* ``output/discovered_field_report_{schema_id}.json`` — coverage stats.
